...
if ($_GET['action'] == 'show') {
  ...
  <tr>
    <td><b>Engin</b></td><td><b>Especes cibles</b></td><td><b>Autorisations actif</b></td>
  </tr>
  <tr>
    <td>
    ...
    while ($results = pg_fetch_row($r_query)) {
        ...
        if(right_write($_SESSION['username'],2,2)) {
          ...
          //if($results[26] == 'f' OR right_write($_SESSION['username'],2,1) == 1 OR $_SESSION['username'] == 'fcardiec') {
...
//        print $query;
        ...
        header("Location: ".$_SESSION['http_host']."/artisanal/view_licenses_license.php?source=$source&table=licenses&action=show");
    }
    $controllo = 1;

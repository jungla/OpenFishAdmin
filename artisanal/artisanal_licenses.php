...
<div style="float: left; width:70%; border: 0px solid black;">
    ...
    <td><?php if(right_write($_SESSION['username'],2,2)) {print '<a href="maintain_licenses_owner.php?source=autorisation&table=owner&action=show"><i class="material-icons">build</i>Manutention</a>';} ?></td>
...
<!--    <td><a href="download_form.php?source=autorisation&table=licenses"><i class="material-icons">file_download</i>T&eacute;l&eacute;charger</a></td>
    ...
    <br/>
    <a href="artisanal_t_table.php?source=table"><i class="material-icons">build</i><b>Modifier Tables</b></a>
    <br/>

...
if ($_GET['action'] == 'map') {
    ...
    $query_maree = "SELECT * FROM thon.maree "
        . "WHERE maree.id = '".$_GET['id_maree']."'";

    $r_query_maree = pg_query($query_maree);
    $results_maree = pg_fetch_row($r_query_maree);
    ...
    <table>
        <tr>
            ...
            <tr>
            <td><a href="./view_thon_maree.php?source=thon&table=maree&action=edit&id=<?php print $results_maree[0]; ?>">Modifier</a></td>
            <td>
            <?php echo $results_maree[3]; ?>
            </td>
            <td><?php echo $results_maree[4]; ?></td>
            <td><?php echo $results_maree[5]; ?></td>
            <td><?php echo $results_maree[6]; ?></td>
            <td><?php echo $results_maree[7]; ?></td>
            <td><?php echo $results_maree[8]; ?></td>
            <td><?php echo $results_maree[9]; ?></td>
            </tr>
    </table>
    ...
    <table>
        <tr>
            <td rowspan="2"></td>
            <td rowspan="2"><b>Utilisateur & date</b></td>
            <td rowspan="2" nowrap><b>Date lanc&eacute;</b><br/>[aaaa-mm-jj]</td>
            ...
            <td rowspan="2"><b>Temperature et vitesse courant</b></td>
            <td rowspan="2"><b>Vitesse et direction vent</b></td>
        ...
        . "WHERE lance.id_maree = '".$_GET['id_maree']."'";
        ...
        while ($results_lance = pg_fetch_row($r_query_lance)) {
            ...
            $query_capture = "SELECT captures.id, captures.datetime, captures.username, id_maree, id_lance, rejete, "
                    . "fishery.species.id, fishery.species.FAO, "
                    . "taille, poids FROM thon.captures "
                    . "LEFT JOIN fishery.species ON fishery.species.id = captures.id_species "
                    . "WHERE captures.id_lance = '$results_lance[0]' ORDER BY datetime DESC";

            #print $query;

            $r_query_capture = pg_query($query_capture);
            
            $ncols = pg_num_rows($r_query_capture);
            
            $i = 0;
            while ($results_capture = pg_fetch_row($r_query_capture)) {
                if ($i == 0) {
                    $i++;
        ?>
        ...
        <tr>
            <td rowspan="<?php print $ncols;?>">
            <a href="./view_thon_lance.php?id_lance=<?php print $results_lance[0]; ?>&source=thon&table=lance&action=edit">Modifier</a><br/>
            <a href="./view_thon_lance.php?id_capture=<?php print $results_capture[0]; ?>&id_maree=<?php print $results_capture[3]; ?>&source=$source&table=$table&action=delete">Effacer</a>
            </td>
            <td rowspan="<?php print $ncols;?>"><?php echo $results_lance[2]."<br/>".$results_lance[1]; ?></td>
            
            <td nowrap rowspan="<?php print $ncols;?>"><?php echo $results_lance[4]; ?></td>
            <td rowspan="<?php print $ncols;?>"><?php echo $results_lance[5]; ?></td>
            <td rowspan="<?php print $ncols;?>"><?php echo $results_lance[6]; ?></td>

            <td nowrap rowspan="<?php print $ncols;?>">
            ...
            <td><?php if($results_capture[7] == 'YFT'){ echo $results_capture[8];} ?></td>
            <td><?php if($results_capture[7] == 'YFT'){ echo $results_capture[9];} ?></td>
            <td><?php if($results_capture[7] == 'SKJ'){ echo $results_capture[8];} ?></td>
            <td><?php if($results_capture[7] == 'SKJ'){ echo $results_capture[9];} ?></td>
            <td><?php if($results_capture[7] == 'BET'){ echo $results_capture[8];} ?></td>
            <td><?php if($results_capture[7] == 'BET'){ echo $results_capture[9];} ?></td>
            <td><?php if($results_capture[7] == 'ALB'){ echo $results_capture[8];} ?></td>
            <td><?php if($results_capture[7] == 'ALB'){ echo $results_capture[9];} ?></td>
            <td><?php if($results_capture[7] != 'YFT' and $results_capture[7] != 'SKJ' and $results_capture[7] != 'BET' and $results_capture[7] != 'ALB') {echo $results_capture[7];}  ?></td>
            <td><?php if($results_capture[7] != 'YFT' and $results_capture[7] != 'SKJ' and $results_capture[7] != 'BET' and $results_capture[7] != 'ALB') { echo $results_capture[8];} ?></td>
            <td><?php if($results_capture[7] != 'YFT' and $results_capture[7] != 'SKJ' and $results_capture[7] != 'BET' and $results_capture[7] != 'ALB') { echo $results_capture[9];} ?></td>
            <td><?php echo $results_capture[5]; ?></td>
            <td rowspan="<?php print $ncols;?>"><?php echo $results_lance[7]; ?></td>
            <td rowspan="<?php print $ncols;?>"><?php echo $results_lance[9]; ?></td>
            <td rowspan="<?php print $ncols;?>"><?php echo $results_lance[10]; ?></td>
            <td rowspan="<?php print $ncols;?>"><?php echo $results_lance[11]." - ".$results_lance[14]; ?></td>
            <td rowspan="<?php print $ncols;?>"><?php echo $results_lance[12]." - ".$results_lance[13];  ?></td>
            <td rowspan="<?php print $ncols;?>"><?php echo $results_lance[15]; ?></td>
        </tr>

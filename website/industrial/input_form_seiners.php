...
if ($_POST['submit'] == "Enregistrer") {
    ...
    $query = "INSERT INTO seiners.route "
            . "(username, datetime, id_navire, maree, date, time, speed, t_activite, t_neighbours, temperature, windspeed, comment, location) "
            . "VALUES ('$username', now(), '$id_navire', '$maree', '$date', '$time', '$speed', '$t_activite', '$t_neighbours','$temperature', '$windspeed', '$comment', ST_GeomFromText($point,4326))";
    ...
    if(!pg_query($query)) {
        ...
        header("Location: ".$_SESSION['http_host']."/executed.php?dest=Insert Data&id_dest=industrial/input_form_seiners.php");
    }
...
if (!$controllo) {
    ...
    <b>Comment</b>
    <br/>
    <input type="text" size="50" name="comment" value="<?php echo $results[13];?>" />
    <br/>
    <br/>
...
if (!$controllo) {
    ...
    <br/>
    <br/>
    <b>Heure de debut</b> (hh:mm:ss)
    <br/>
    <input type="time" size="20" name="h_d" />
    <br/>
    <br/>
    <b>Fin de coulissage</b> (hh:mm:ss)
    <br/>
    <input type="time" size="20" name="h_c" />
    <br/>
    <br/>
    <b>Heure de fin</b> (hh:mm:ss)
    <br/>
    ...
    <option  value="none">Please choose from above</option>
    <?php
    $result = pg_query("SELECT DISTINCT id, family, genus, species, francaise FROM fishery.species WHERE family = '$results[27]' ORDER BY genus, species");
    while($row = pg_fetch_row($result)) {
...
if (!$controllo) {
    ...
    <br/>
    <br/>
    <b>Nombre individu par taille (cm)</b>
    <table border="1">
    <?php
...
if (!$controllo) {
    ...
    <b>Heure de debut</b> (hh:mm:ss)
    <br/>
    <input type="timext" size="20" name="h_d" />
    <br/>
    <br/>
    <b>Fin de coulissage</b> (hh:mm:ss)
    <br/>

...
if ($_POST['submit_species'] == "Submit") {
   ...
   . "(username, datetime_d, datetime_r, obs_name, t_site, fish_name, license, t_net, net_s, net_l, n_days, t_group, id_species, sample_s, n_ind, gps_file, gps_yn, gps_track) "
   . "VALUES ('$username','$datetime_d','$datetime_r', '$obs_name', '$t_site', '$fish_name', '$license', '$t_net', '$net_s', '$net_l', '$n_days', '$t_group', '$id_species', '$sample_s', '$n_ind', '$gps_file', '$gps_yn', ST_GeomFromText('$gps_track[0]',4326));";
...
if (!$controllo) {
	...
	<form method="post" action="<?php echo $radice;?>" enctype="multipart/form-data"><br/>
        ...
        <b>Species</b>
        <br/>
        <input type="text" size="6" name="id_species" value="<?php echo $rejet;?>" />
        <br/>
        <br/>

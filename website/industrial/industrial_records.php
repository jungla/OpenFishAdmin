...
<h2 style="background-image: url('../img/tuna.png'); background-repeat: no-repeat; padding-left: 230px;" >P&ecirc;che Thoni&egrave;re a la Senne<br/>Programme Observateurs</h2>
    ...
    <tr>
    <td>Capture de mammif&eacute;re marin</td>
    ...
    <tr>
    <td>Capture de requins, rais et molas</td>
    ...
    <table id="results">
        <tr><td>Rapport mar&eacute;e chalutier</td>
            <td>
                <form name="maree" method="post" action="./pdf_analysis_trawlers.php" enctype="multipart/form-data">
                <select name='maree'>
                    <?php
                    $query = "SELECT DISTINCT maree FROM trawlers.route ORDER BY maree DESC";
...
<h2 style="background-image: url('../img/shrimp.png'); background-repeat: no-repeat; padding-left: 230px;" >P&ecirc;che Crevettier<br/>Logbook Capitaine</h2>
    ...
    <td><?php if(right_write($_SESSION['username'],8,2)) {print '<a href="crevette/input_crevette.php?source=crevette&table=lance"><i class="material-icons">create</i>Saisir</a>';} ?></td>
    ...
    <td></td>
    <td><?php if(right_write($_SESSION['username'],8,2)) {print '<a href="crevette/input_crevette.php?source=crevette&table=captures"><i class="material-icons">create</i>Saisir</a>';} ?></td>

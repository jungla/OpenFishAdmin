...
//        print $query;
        ...
        header("Location: ".$_SESSION['http_host']."/artisanal/view_licenses_owner.php?source=$source&table=owner&action=show");
    }
    $controllo = 1;
...
//        print $query;
        ...
        header("Location: ".$_SESSION['http_host']."/artisanal/view_licenses_owner.php?source=$source&table=$table&action=edit&id=$id");
    }

...
$_SESSION['filter']['s_fish_id'] = $_POST['s_fish_id'];
...
if ($_GET['action'] == 'show') {
    ...
    if ($results[14] != "") {
        ...
        print "<form method=\"post\" action=\"$self\" enctype=\"multipart/form-data\">"
            . "<a href=\"image.php?id=$id&table=artisanal.fisherman&photo_data=photo_data\"><img class=\"img_frame\" width=\"300px\" src=\"image.php?id=$id&table=artisanal.fisherman&photo_data=photo_data\" /></a>"
            . "<br/>"
            . "<button class=\"thin\" name=\"delete\" value=\"Supprimer\" ><i class=\"material-icons\">delete</i>Supprimer</button>&nbsp;"
            . "<button class=\"thin\" name=\"rotate\" value=\"Rotate\" ><i class=\"material-icons\">rotate_90_degrees_ccw</i>Tourner</button>"
...
//        print $query;
        ...
        header("Location: ".$_SESSION['http_host']."/artisanal/mantainance/view_licenses_fisherman.php?source=$source&table=fisherman&action=show");
    }
    $controllo = 1;
...
if ($_POST['delete'] == "Supprimer") {
    ...
    $query = "UPDATE artisanal.fishermen SET "
    . " photo_data = NULL "
    . " WHERE id = '$id'";

...
<fieldset class="border">
    ...
    <script type="text/javascript">
        ...
        cropper.getCroppedCanvas().toBlob(function (blob) {
            ...
            $.ajax('<?php echo $GLOBALS['path']; ?>/artisanal/upload.php?table=owner&id=<?php echo $_GET['id']; ?>', {
                method: "POST",
                data: formData,
                processData: false,
                contentType: false,
...
//        print $query;
        ...
        header("Location: ".$_SESSION['http_host']."/artisanal/mantainance/view_licenses_owner.php?source=$source&table=$table&action=edit&id=$id");
    }
...
if ($_POST['submit'] == "Enregistrer") {
   ...
   $query = str_replace('\'\'', 'NULL', $query);
    ...
    if(!pg_query($query)) {
        ...
        #print $query;
        header("Location: ".$_SESSION['http_host']."/artisanal/view_licenses_owner.php?source=$source&table=owners&action=show");
    }

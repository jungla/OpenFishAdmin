...
if ($_GET['action'] == 'show') {
    ...
    if ($_SESSION['filter']['f_license'] != "" OR $_SESSION['filter']['f_year'] != "" OR $_SESSION['filter']['s_immatriculation'] != ""
    OR $_SESSION['filter']['f_t_site'] != "" OR $_SESSION['filter']['f_t_license'] != "" OR $_SESSION['filter']['f_active'] != "") {
...
//        print $query;
        ...
        #print $query;
        header("Location: ".$_SESSION['http_host']."/artisanal/administration/view_licenses_validate.php?source=$source&table=licenses&action=show");
    }

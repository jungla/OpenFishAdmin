...
<fieldset class="border">
    ...
    <script type="text/javascript">
        ...
        cropper.getCroppedCanvas().toBlob(function (blob) {
            ...
            $.ajax('<?php echo $GLOBALS['path']; ?>/artisanal/administration/upload.php?table=fisherman&id=<?php echo $_GET['id']; ?>', {
                method: "POST",
                data: formData,
                processData: false,
                contentType: false,
...
//        print $query;
        ...
        header("Location: ".$_SESSION['http_host']."/artisanal/administration/view_licenses_fisherman.php?source=$source&table=fisherman&action=show");
    }
    $controllo = 1;
...
//        print $query;
        ...
        header("Location: ".$_SESSION['http_host']."/artisanal/administration/view_licenses_fisherman.php?source=$source&table=$table&action=edit&id=$id");
    }

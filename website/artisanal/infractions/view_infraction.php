...
<tr><td><b>D&eacute;tails Pirogue</b></td><td>
  <?php
if ($results[6] != '') {
  print "<a href=\"../administration/view_pirogue.php?id=$results[6]\">";
...
?></td></tr>
    ...
    <?php
      if ($results[9] != '') {
        ...
        print "<a href=\"../administration/view_owner.php?id=$results[9]\">".strtoupper($owner[0])." ".ucfirst($owner[1]);
      } else {
    ...
    <?php
      if ($results[16] != '') {
        ...
        $owner = pg_fetch_row(pg_query($query));
        print "<a href=\"../administration/view_fisherman.php?id=$results[16]\">".strtoupper($owner[0])." ".ucfirst($owner[1]);
      } else {
    ...
    <?php
      if ($results[23] != '') {
        ...
        $owner = pg_fetch_row(pg_query($query));
        print "<a href=\"../administration/view_fisherman.php?id=$results[23]\">".strtoupper($owner[0])." ".ucfirst($owner[1]);
      } else {
    ...
    <?php
      if ($results[30] != '') {
        ...
        $owner = pg_fetch_row(pg_query($query));
        print "<a href=\"../administration/view_fisherman.php?id=$results[30]\">".strtoupper($owner[0])." ".ucfirst($owner[1]);
      } else {
    ...
    <?php
      if ($results[37] != '') {
        ...
        $owner = pg_fetch_row(pg_query($query));
        print "<a href=\"../administration/view_fisherman.php?id=$results[37]\">".strtoupper($owner[0])." ".ucfirst($owner[1]);
      } else {

...
if ($_GET['action'] == 'show') {
    ...
    while ($results = pg_fetch_row($r_query)) {
        if ($results[7] != "") {
            ...
            $res_l = "<a href=\"../administration/view_license.php?id=$results[7]\">".pg_fetch_row(pg_query($query))[1]."</a>";
        } else {
            $res_l = $results[8];
        }
...
//        print $query;
        ...
        header("Location: ".$_SESSION['http_host']."/artisanal/inspectors/view_records_capture.php?source=$source&table=captures&action=show");
    }
...
//        print $query;
        ...
        header("Location: ".$_SESSION['http_host']."/artisanal/inspectors/view_records_capture.php?source=$source&table=captures&action=edit&id=".$_POST['id']);
    }

...
if ($_GET['action'] == 'show') {
    ...
    while ($results = pg_fetch_row($r_query)) {
        ...
        if ($results[8] != '') {
          ...
          //print $query;
          print "<td nowrap><a href=../administration/view_pirogue.php?id=$results[8]>$immatriculation[0]</a></td>";
        } else {
...
//        print $query;
    ...
    header("Location: ".$_SESSION['http_host']."/artisanal/inspectors/view_records_capture.php?source=$source&table=$table&action=show");
...
if ($_POST['submit'] == "Enregistrer") {
            ...
            header("Location: ".$_SESSION['http_host']."/executed.php?dest=Insert Data&id_dest=artisanal/inspectors/input_records.php");

...
if ($_GET['action'] == 'show') {
    ...
    while ($results = pg_fetch_row($r_query)) {
        ...
        print "<tr align=\"center\">";
          ...
          print "<td rowspan=2 ><a href=\"./duplicate_licenses_fisherman.php?source=$source&table=$table&action=merge&id_1=$results[1]&id_2=$results[17]\">Merge</a></td>";
        ...
        print "<td nowrap><a href=\"../administration/view_fisherman.php?id=$results[1]\">Voir</a></td><td nowrap>$results[2]<br/>$results[3]</td><td>".strtoupper($results[5])."<br/>".ucfirst($results[4])."</td><td nowrap>$results[6]</td><td>$results[7]<br/>$results[8]</td>"
        ...
        . "<td>$results_p_1[0]</td><td>".$results_i_1[0]."</td><td>$photo_data_bool</td></tr>";
          ...
          print "<td nowrap><a href=\"../administration/view_fisherman.php?id=$results[17]\">Voir</a></td><td nowrap>$results[18]<br/>$results[19]</td><td>".strtoupper($results[21])."<br/>".ucfirst($results[20])."</td><td nowrap>$results[22]</td><td>$results[23]<br/>$results[24]</td>"
    ...
    pages($start,$step,$pnum,'./duplicate_licenses_fisherman.php?source=autorisation&table=fisherman&action=show');
    ...
    <table>
      ...
      while ($results = pg_fetch_row($r_query_p)) {
            print "<tr align=\"center\"><td><a href=\"../administration/view_carte.php?id=$results[0]&source=license&table=carte\">Voir</a></td><td>$results[1]</td><td>$results[5]</td>";

            if ($results[13] != "") {
                print "<td><a href=\"../administration/view_license.php?id=$results[12]\">$results[4]</a></td>";
            } else {
                print "<td>Aucun</td>";
...
if ($_POST['submit'] == "Enregistrer") {
  ...
  header("Location: ".$_SESSION['http_host']."/artisanal/maintenance/duplicate_licenses_fisherman.php?source=$source&table=fishermans&action=show");

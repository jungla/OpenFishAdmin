...
if ($_GET['action'] == 'show') {
    ...
    if ($table == 't_site_obb') {
      ...
      $query = "SELECT *, st_y(location), st_x(location) FROM artisanal.t_site_obb ORDER BY site";
...
//        print $query;
        ...
        header("Location: ".$_SESSION['http_host']."/artisanal/mantainance/view_artisanal_t_table.php?source=$source&table=$table&action=show");
    }
    $controllo = 1;
...
if ($_POST['submit'] == "Enregistrer") {
    ...
    if ($lon == '' OR $lat == '') {
      $query = "UPDATE artisanal.t_site_obb SET "

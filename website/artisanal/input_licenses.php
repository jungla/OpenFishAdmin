...
//        print $query;
        msg_queryerror();
                ...
                header("Location: ".$_SESSION['http_host']."/executed.php?dest=Insert%20Data&id_dest=artisanal/input_licenses.php?table=licenses");
    }
       ...
       . "VALUES ('$username','$name', '$immatriculation', '$t_pirogue', '$length', '$id_owner','$comments', '$photo_data_1', '$photo_data_2', '$photo_data_3') RETURNING id;";
        ...
        if(!$rquery) {
            ...
            if(!pg_query($query)) {
                ...
                header("Location: ".$_SESSION['http_host']."/executed.php?dest=Insert%20Data&id_dest=artisanal/input_licenses.php?table=pirogue");
            }
        }
...
<!--	<script type="text/javascript" src="<?php print $path;?>/webcam.js"></script>
	-->
...
if ($_POST['submit'] == "Enregistrer") {
    ...
    if(!pg_query($query)) {
      ...
      header("Location: ".$_SESSION['http_host']."/executed.php?dest=Insert%20Data&id_dest=artisanal/input_licenses.php?table=owner");
...
<?php
    ...
    if ($_POST['submit'] == "Enregistrer") {
        ...
        if(!pg_query($query)) {
          ...
          header("Location: ".$_SESSION['http_host']."/executed.php?dest=Insert%20Data&id_dest=artisanal/input_licenses.php?source=autorisation&table=fisherman");
    ...
    if ($_POST['submit'] == "Enregistrer") {
       ...
       # id, datetime, username, carte, id_fisherman, payment, receipt, date_d, date_f, id_license, carte_saisie
        ...
        if(!pg_query($query)) {
            ...
            header("Location: ".$_SESSION['http_host']."/executed.php?dest=Insert%20Data&id_dest=artisanal/input_licenses.php?source=autorisation&table=carte");
        }

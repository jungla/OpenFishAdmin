...
$_SESSION['path'][1] = $_GET['source'];
$_SESSION['path'][2] = $_GET['table'];
...
echo "<a href=\"./input.php?method=$method\">".$method."</a> > "
        . "<a href=\"./input_form.php?method=$method&source=$source\">".$source."</a> > "
        . "<a href=\"./input_form_trw.php?method=$method&source=$source&table=$table\">".$table."</a>";

...
#file_csv = '../../CSV_data/artisanal_autorizations/artisanal_T_SITE_OBB.csv'
...
with open(filename, 'rt') as csvfile:
 ...
 #  query = "INSERT INTO artisanal.t_site_obb (site, strata, region, code, location) VALUES (%s, %s, %s, %s, ST_GeomFromText('POINT(%s %s)',4326))"
 #  print query
 ...
 # else:
  query = "INSERT INTO artisanal.t_site_obb (site, strata, region, code, active) VALUES (%s, %s, %s, %s, %s)"
  print(query)
  cur.execute(query,(peche_sql.title(lines[0]),peche_sql.title(lines[1]),peche_sql.title(lines[2]),lines[5],'true'))

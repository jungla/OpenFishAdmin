...
#file_csv = '../../CSV_data/artisanal_autorizations/artisanal_T_SITE.csv'
...
#   query = "INSERT INTO artisanal.t_site (site, strata, region, code, latitude, longitude) VALUES (%s, %s, %s, %s, %s, %s"

...
table_names = ['T_INFRACTION'.lower(),'T_ORG'.lower()]

for table_name in table_names:

 path = '/Users/jeanmensa/Google_Drive/Gabon_Bleu/_database/CSV_data/infraction/'
 filename = 'infraction_'+table_name.upper()+'.csv_out'

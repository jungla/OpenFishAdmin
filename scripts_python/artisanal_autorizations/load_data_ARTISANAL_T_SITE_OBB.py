...
file_csv = '/Users/jeanmensa/Google_Drive/Gabon_Bleu/_database/CSV_data/artisanal/artisanal_T_SITE_OBB.csv_out'
...
# spamreader.next()
 ...
 for lines in spamreader:
  ...
  if lines[3] != None and lines[4] != None:
   ...
   query = "INSERT INTO artisanal.t_site_obb (site, strata, region, code) VALUES (%s, %s, %s, %s)"
   print query

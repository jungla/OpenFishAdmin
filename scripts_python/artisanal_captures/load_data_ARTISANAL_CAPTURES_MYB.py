...
#   username, datetime_d, datetime_r, obs_name, t_site, license_id, license_num, t_gear, net_s, net_l, cap_tot, id_species, sample_s, n_ind, gps_file 
  ...
  query = "INSERT INTO artisanal.captures (username, datetime_d, datetime_r, obs_name, t_site, license_id, immatriculation, t_gear, net_s, net_l, cap_tot, id_species, sample_s, n_ind,t_study) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
#  print query
  cur.execute(query,('jmensa', datetime_d, datetime_r, obs_name, t_site, license_id, immatriculation, t_gear, net_s, net_l, cap_tot, id_species, sample_s, n_ind,t_study))

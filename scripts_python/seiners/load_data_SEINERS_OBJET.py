...
for year in years:
 ...
 with open(path+filename, 'rb') as csvfile:
  ...
  # navire, zee, n_objet, n_route, l_route, t_objet, type_balise, code_balise, t_operation, t_peche, t_appartenance, t_devenir, remarquqe
   ...
   t_objet = peche_sql.convertID(os.environ['HOME']+'/Google_Drive/Gabon_Bleu/_database/CSV_data/seiners/seiners_T_OBJET_CONV.csv',lines[5])
   t_operation = peche_sql.convertID(os.environ['HOME']+'/Google_Drive/Gabon_Bleu/_database/CSV_data/seiners/seiners_T_OPERATION_CONV.csv',lines[8])
   t_appartenance = peche_sql.convertID(os.environ['HOME']+'/Google_Drive/Gabon_Bleu/_database/CSV_data/seiners/seiners_T_APPARTENANCE_CONV.csv',lines[9])
   t_devenir = peche_sql.convertID(os.environ['HOME']+'/Google_Drive/Gabon_Bleu/_database/CSV_data/seiners/seiners_T_DEVENIR_CONV.csv',lines[10])
